...
const ToastNotification: React.FC<ToastNotificationProps> = ({ isSuccess }) => {
  ...
  return (
    <div
      id="toast-top-right"
      className="fixed flex items-center w-full max-w-xs mt-16 mr-12 p-4 space-x-4 text-gray-500 bg-white divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow-sm top-5 right-5 "
      role="alert"
    >
      <div
        id="toast-success"
